...
export const LIVESTREAM_BG_PRESETS: Record<string, BgPreset> = {
  ...
  'ember': {
    label: '烈焰',
    bg: 'linear-gradient(135deg, #1c0a0a 0%, #3b1414 35%, #2e0f20 70%, #1a0a10 100%)',
    shadowColor: '#180a0a',
    grainOpacity: 0.13,
    isDark: true,
  ...
  'forest': {
    label: '森林',
    bg: 'linear-gradient(135deg, #052e16 0%, #14532d 35%, #166534 70%, #052e16 100%)',
    shadowColor: '#062014',
    grainOpacity: 0.12,
    isDark: true,
    glowA: 'rgba(34,197,94,0.22)',
    glowB: 'rgba(134,239,172,0.14)',
  },
  'aurora-pink': {
    label: '极光粉',
