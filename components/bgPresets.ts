...
export const CLASSROOM_BG_PRESETS: Record<string, BgPreset> = {
  ...
  'sage': {
    label: '晴空',
    bg: 'linear-gradient(135deg, #eef4fb 0%, #e2edf8 40%, #e8f1fa 70%, #f2f7fc 100%)',
    shadowColor: '#e6eef8',
    grainOpacity: 0.06,
    isDark: false,
    glowA: 'rgba(96,150,220,0.20)',
    glowB: 'rgba(150,195,240,0.22)',
    accent: '#3f7fd0',
    accentSoft: '#cfe0f4',
  },
  'night-class': {
    label: '夜课',
    bg: 'linear-gradient(135deg, #0d1424 0%, #131d33 40%, #172542 70%, #0c1120 100%)',
    shadowColor: '#0b101d',
    grainOpacity: 0.12,
    isDark: true,
    glowA: 'rgba(99,132,220,0.26)',
    glowB: 'rgba(120,180,235,0.2)',
    accent: '#7aa5e6',
    accentSoft: '#c3d6f0',
  },
};
